...
type
    ...
    public
        ...
        procedure GerarSqlAlteracao(out sql: WideString; out parametros: TParametro);
...
procedure TFabricaSQL.GerarSqlAlteracao(out sql: WideString; out parametros: TParametro);
var
  campos: TStringList;
  item: string;
...
begin
    try
        ...
        parametros := FBase.ObjetoParaParametros(Alteracao);

        if sqlCampos <> EmptyStr then
