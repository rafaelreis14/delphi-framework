...
type
    ...
    procedure lblNumeroOperacaoClick(Sender: TObject);
...
procedure TfrmInventario.AcionarRobo;
var
    count: integer;
    i, j: Integer;
begin
    ...
    begin
        count := random(4);
        for j := 1 to count do
            Fila.AdicionarTarefa('012705',inttostr(j),'',1);
...
procedure TfrmInventario.lblNumeroOperacaoClick(Sender: TObject);
begin
  AcionarRobo;
end;
