...
uses Biz.Usuario, Lib.Lista, Biz.Filial, Biz.Grupo, Biz.Modulo, Biz.Rotina, Lib.Persistable,
    ...
    try
        ...
        try
            ...
            begin
                ...
                Self.Obter(UpperCase(Dataset.FieldByName('S01_LOGIN').AsString));
                ...
                Self.Recno := Dataset.FieldByName('R_E_C_N_O_').AsInteger;
