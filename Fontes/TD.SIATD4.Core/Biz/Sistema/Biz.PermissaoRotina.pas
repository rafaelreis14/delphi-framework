...
type
    ...
    public
        ...
        /// <summary>
        /// Metodo que faz a inserção da PermissaoRotina
        /// </summary>
        function Inserir: integer;
        /// <summary>
        /// Metodo que faz a alteração da PermissaoRotina
        /// </summary>
        function Alterar: boolean;

        /// <summary>
        /// Métido que faz a Deleção da PermissaoRotina
        /// </summary>
...
function TPermissaoRotina.Inserir: integer;
begin
    try
        try
...
begin
    ...
    try
        try
            ...
            query := 'DELETE FROM '+Self.TabelaReferencia+' WHERE S19_S05_ROTINA = :S19_S05_ROTINA';

            dao.Excluir(query, Parametro);
        except
            on e: exception do
                raise exception.Create('Erro ao excluir Permissões da Rotina ' + #13 + e.Message);
        end;
    finally
        FreeAndNil(Parametro);
    end;
