...
uses
    ...
    Lib.MaxLenght, Biz.Adminsitradora, Lib.Lista, Dal.ControleDados;
...
begin
    ...
    try
        try
            ...
            raise Exception.Create('Erro ao alterar condição de pagamento do orçamento');
...
begin
    ...
    try
        try
            ...
            raise Exception.Create('Erro ao inserir condição de pagamento  do orçamento');
...
begin
    ...
    try
        try
            ...
            raise Exception.Create('Erro ao excluir condicao de pagamento do orçamento');
...
begin
    ...
    try
        try
            ...
            raise Exception.Create('Erro ao excluir condições de pagamento do orcamento');
        end;
