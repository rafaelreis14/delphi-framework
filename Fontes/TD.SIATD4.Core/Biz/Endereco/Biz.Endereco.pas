...
type
    TEndereco = class(TClasseBase, ICRUD<TEndereco>)
  private
    FLogradouro: string;
    FBairro: string;
    ...
    public
        ...
        [TPersistable(fgPersistable, 'ZT_XCODBAI')]
        [TMaxLenght(8)]
...
function TEndereco.Alterar: boolean;
begin
...
function TEndereco.Excluir: boolean;
begin
end;
...
procedure TEndereco.SetCodigoBairroTOTVS(const Value: string);
begin
