...
begin
  ...
  begin
     try
         try
             TAguarde.AguardandoFinalizacaoProcesso(Self, 'Aguarde, obtendo informações do Serasa.');
             ...
             begin
                 ...
                 tlib.MensagemInformacao('Informações inseridas corretamente, favor consultá-las no SIATD 1.0');
             end
             else
             begin
                TAguarde.ProcessoFinalizado;
                tlib.MensagemInformacao('Já existem informações do Serasa para este cliente, favor consultá-las no SIATD 1.0');
             end;
